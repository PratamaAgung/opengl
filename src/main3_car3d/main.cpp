...
int main(int argc, char** argv) {
    ...
    tire_color[1] = 0.1f;
    tire_color[2] = 0.1f;
    createTire(tires[0], -0.4523350000000001f, -0.22941000000000004f, 0.45f, 0.17f, side, tire_color, 0.125f);
    createTire(tires[1], 0.6048599999999999f, -0.22941000000000004f, 0.45f, 0.18f, side, tire_color, 0.125f);
    createTire(tires[2], -0.4523350000000001f, -0.22941000000000004f, -0.45f, 0.17f, side, tire_color, 0.125f);
    createTire(tires[3], 0.6048599999999999f, -0.22941000000000004f, -0.45f, 0.18f, side, tire_color, 0.125f);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 projection;
        projection = glm::perspective(glm::radians(45.0f), 800.0f / 800.0f, 0.5f, 100.0f);
