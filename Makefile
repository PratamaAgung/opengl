...
task_1:
	g++ src/main1_triangle/main_1.cpp -o bin/main1 -lglfw -lGLEW -lGL
	g++ src/main1_triangle/main_1_uniform.cpp -o bin/main1_uniform -lglfw -lGLEW -lGL
	g++ src/main1_triangle/main_1_opengl2.cpp -o bin/main1_opengl2 -lglut -lGL
